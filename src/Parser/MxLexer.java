...
public class MxLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FormatStr", "Format_Plain", "Head", "Middle", "Tail", "Whitespace", 
			"Newline", "Plus", "Minus", "Mul", "Div", "Mod", "Less", "LessEqual", 
			"Greater", "GreaterEqual", "Equal", "NotEqual", "AndAnd", "OrOr", "Not", 
			"LeftShift", "RightShift", "And", "Or", "Caret", "Tilde", "Assign", "PlusPlus", 
			"MinusMinus", "Dot", "LeftParen", "RightParen", "LeftBracket", "RightBracket", 
			"LeftBrace", "RightBrace", "Semi", "Comma", "Question", "Colon", "Void", 
			"Bool", "Int", "String", "New", "Class", "Null", "True", "False", "This", 
			"If", "Else", "For", "While", "Break", "Continue", "Return", "Identifier", 
			"BlockComment", "LineComment", "BoolLiteral", "DecimalInteger", "StringLiteral"
		};
	}
